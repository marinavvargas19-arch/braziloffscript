...
export const TOURS = [
  ...
  { slug:"honeymoon-brazil",          title:"Honeymoon in Brazil",           days:12, price:6900, category:"paradise-found",     regions:["Rio","Búzios","Fernando de Noronha"],                img:"/noronha-beach.jpg",    tags:["Honeymoon","Beach","Romance"],      blurb:"A romantic Brazil escape pairing Rio's cinematic energy, Búzios' barefoot charm, and Noronha's protected island beauty." },
];
...
// ---- Honeymoon in Brazil — 12-day itinerary ----
export const HONEYMOON_ITIN = [
  { route:"Rio de Janeiro Int'l Airport (GIG) → Ipanema", city:"First Night in Rio", img:"/rio-sunset.jpg", meals:"",
    blocks:[
      {kind:"Arrival", title:"Private arrival", desc:"Arrive in Rio and transfer to a romantic hotel in Ipanema or Leblon, with the rest of the day kept intentionally light."},
      {kind:"Evening", title:"Sunset and welcome dinner", desc:"Ease into Brazil with sunset at Arpoador and a private dinner reservation by the sea."},
    ]},
  { route:"Rio de Janeiro · icons", city:"Rio's Cinematic Side", img:IMG.rioChrist, meals:"Breakfast",
    blocks:[
      {kind:"Icon", title:"Christ the Redeemer and Sugarloaf", desc:"Discover Rio's most iconic viewpoints with private guiding and timing designed around beautiful light."},
      {kind:"Evening", title:"Dinner with a view", desc:"End the day with a table chosen for atmosphere, food, and a sense of occasion."},
    ]},
  { route:"Rio de Janeiro · coast and gardens", city:"A Softer Rio", img:"/parque-lage.jpg", meals:"Breakfast",
    blocks:[
      {kind:"Nature", title:"Botanical Garden and Parque Lage", desc:"A gentle day through gardens, forested corners, and photogenic architecture beneath Corcovado."},
      {kind:"At leisure", title:"Beach time", desc:"Spend the afternoon at your own pace along Ipanema, Leblon, or your hotel pool."},
    ]},
  { route:"Rio de Janeiro · private sailing", city:"Rio by Water", img:"/rio-day-6-sailing.jpg", meals:"Breakfast",
    blocks:[
      {kind:"Boat", title:"Private sailing on Guanabara Bay", desc:"See Rio from the water on a private sailing experience with drinks, views, and time to unwind."},
      {kind:"Evening", title:"Free evening", desc:"Keep the evening flexible for a quiet dinner or a livelier night out."},
    ]},
  { route:"Rio de Janeiro → Búzios", city:"From City to Sea", img:"/buzios-aerial.jpg", meals:"Breakfast",
    blocks:[
      {kind:"Transfer", title:"Scenic coastal drive", desc:"Leave Rio for Búzios, a peninsula of coves, boutique hotels, and slow seaside days."},
      {kind:"Evening", title:"Orla Bardot", desc:"Walk the waterfront at golden hour before dinner in the village."},
    ]},
  { route:"Búzios · peninsula beaches", city:"Barefoot Búzios", img:"/buzios-stairs.jpg", meals:"Breakfast",
    blocks:[
      {kind:"Beach", title:"Coves and clear water", desc:"Explore the peninsula's beaches, from calm turquoise bays to more dramatic Atlantic viewpoints."},
      {kind:"At leisure", title:"Spa or beach club", desc:"Add a couples spa treatment, beach club afternoon, or simply keep the day unplanned."},
    ]},
  { route:"Búzios · private boat", city:"A Day at Sea", img:"/buzios-sunset-sail.jpg", meals:"Breakfast",
    blocks:[
      {kind:"Boat", title:"Private boat charter", desc:"Spend the day by boat, stopping at coves and swimming spots selected according to weather and sea conditions."},
      {kind:"Food", title:"Long lunch by the water", desc:"Pause for a relaxed seafood lunch before returning for sunset."},
    ]},
  { route:"Búzios → Fernando de Noronha", city:"Island Arrival", img:"/noronha.jpg", meals:"Breakfast",
    blocks:[
      {kind:"Flight", title:"To Fernando de Noronha", desc:"Travel to Fernando de Noronha, Brazil's protected island paradise."},
      {kind:"Evening", title:"First island sunset", desc:"Settle in and watch your first Noronha sunset with the ocean taking over the horizon."},
    ]},
  { route:"Fernando de Noronha · beaches", city:"The Island's Icons", img:"/noronha-beach.jpg", meals:"Breakfast",
    blocks:[
      {kind:"Beach", title:"Sancho, Cacimba and viewpoints", desc:"Discover Noronha's most beautiful beaches and viewpoints with a local guide who adjusts the day around tides and visibility."},
      {kind:"At leisure", title:"Time to swim", desc:"Leave generous space for swimming, resting, and simply being on the island."},
    ]},
  { route:"Fernando de Noronha · water day", city:"The Blue Around Noronha", img:"/noronha-beach.jpg", meals:"Breakfast",
    blocks:[
      {kind:"Water", title:"Snorkeling or boat experience", desc:"Explore the island's marine life through a guided snorkeling outing or boat experience, depending on conditions."},
      {kind:"Evening", title:"Dinner under the stars", desc:"A special dinner reservation closes the day."},
    ]},
  { route:"Fernando de Noronha · at leisure", city:"No Plans, Just Island Time", img:"/paradise-found.jpg", meals:"Breakfast",
    blocks:[
      {kind:"At leisure", title:"A day for two", desc:"Keep the day open for your favorite beach, a massage, a slow lunch, or one more swim in clear water."},
      {kind:"Farewell", title:"Final sunset", desc:"Toast the final night from one of the island's classic sunset spots."},
    ]},
  { route:"Fernando de Noronha Airport (FEN)", city:"Departure", img:"/noronha.jpg", meals:"Breakfast",
    blocks:[
      {kind:"Morning", title:"One last breakfast", desc:"Enjoy a final island morning before checkout."},
      {kind:"Departure", title:"Private airport transfer", desc:"Transfer to the airport for your onward journey."},
    ]},
];
