...
export const TOURS = [
  ...
  { slug:"foz-iguacu-extended-5-days",title:"Foz Off Script",              days:6,  price:2200, category:"the-explorer",       regions:["Foz do Iguaçu"],                                    img:"/iguazu-falls.jpg",     tags:["Nature","Conservation"],            hotelChanges:"No", blurb:"The legendary falls, plus the rivers, forests, wildlife, and conservation work that make this region one of Brazil's great natural treasures.",
...
export const FOZ_ITIN = [
  { route:"Arrival in Foz do Iguaçu", city:"Arrival at the Triple Frontier", img:"/iguazu.jpg", meals:"Dinner",
    blocks:[
  ...
  { route:"Itaipu Binacional · Paraná River", city:"Rivers, Energy & Conservation", img:IMG.iguazu, meals:"Breakfast · Dinner",
    blocks:[
...
export const RIO_ITIN = [
  ...
  { route:"Rio de Janeiro · Carioca life", city:"The Carioca Way of Life", img:"/rio-day-5-carioca.jpg", imgPosition:"center 45%", meals:"Breakfast",
    blocks:[
      {kind:"Coffee", title:"Specialty coffee culture", desc:"Beyond the landmarks lies the rhythm that defines Rio. Begin with the city's specialty coffee scene and the rituals of everyday life."},
      {kind:"Local life", title:"Local markets & beach lifestyle", desc:"Experience Rio through its people, flavors, traditions, and beach culture."},
      {kind:"Gastronomy", title:"Brazilian gastronomy", desc:"Taste the city's food culture, from neighborhood favorites to contemporary Brazilian cooking."},
      {kind:"Evening", title:"Live music & authentic samba", desc:"End the day with live music and an authentic samba experience that connects you to Rio's social rhythm."},
    ]},
  { route:"Rio de Janeiro · your choice", city:"Rio, Your Way", img:"/rio-helicopter.jpg", meals:"Breakfast",
    blocks:[
...
{ route:"Manaus → Novo Airão", city:"Into the World's Largest River Archipelago", img:"/amazon.jpg", meals:"Breakfast · Lunch",
blocks:[
...
{ route:"Novo Airão · Anavilhanas", city:"Lost Among the Islands", img:"/amazon.jpg", meals:"Breakfast · Lunch",
blocks:[
...
{ route:"Novo Airão · riverside communities", city:"Life Between Water and Forest", img:"/amazon.jpg", meals:"Breakfast · Lunch",
blocks:[
...
{ route:"Novo Airão · rainforest", city:"When the Forest Wakes Up", img:"/amazon.jpg", meals:"Breakfast · Dinner",
blocks:[
...
{ route:"Novo Airão → Rio Negro Expedition", city:"Into the Deep Amazon", img:"/amazon.jpg", meals:"Breakfast · Lunch",
blocks:[
...
{ route:"Rio Negro Expedition", city:"Sunset on a Hidden Sandbank", img:"/amazon.jpg", meals:"Breakfast · Lunch",
blocks:[
...
{ route:"Rio Negro Expedition", city:"Life Along the River", img:"/amazon.jpg", meals:"Breakfast · Dinner",
blocks:[
