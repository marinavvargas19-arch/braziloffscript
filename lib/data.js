...
export const RIO_ITIN = [
  { route:"Rio de Janeiro Int'l Airport (GIG/GRU) → Ipanema", city:"First Glimpse of Rio", img:IMG.rioSugar, meals:"",
    blocks:[
  ...
  { route:"Rio de Janeiro · Botanical Garden, Lage & hidden viewpoints", city:"Beyond the Postcards", img:IMG.rioSugar, meals:"Breakfast · Lunch",
    blocks:[
  ...
  { route:"Rio de Janeiro · Tijuca National Park", city:"The Urban Rainforest", img:IMG.rioSugar, meals:"Breakfast · Lunch",
    blocks:[
  ...
  { route:"Rio de Janeiro → Búzios", city:"From City to Sea", img:IMG.beach, meals:"Breakfast · Dinner",
    blocks:[
  ...
  { route:"Búzios · peninsula beaches", city:"The Búzios Peninsula", img:IMG.beach, meals:"Breakfast · Lunch",
    blocks:[
  ...
  { route:"Búzios · Arraial do Cabo", city:"The Brazilian Caribbean", img:IMG.beach, meals:"Breakfast · Lunch",
    blocks:[
