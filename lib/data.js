...
export const DESTINATIONS = [
  ...
  { slug:"bahia",         name:"Bahia Off Script",            region:"Bahia & the Northeast",   category:"beyond-the-obvious", img:"/bahia-farol.jpg",       blurb:"Afro-Brazilian culture, barefoot luxury, music, gastronomy, and slow coastal living." },
  { slug:"bahia-extended",name:"Bahia Off Script Extended",   region:"Bahia & the Northeast",   category:"beyond-the-obvious", img:"/bahia-corumbau.jpg",    blurb:"Everything in our signature Bahia journey and more — extra unhurried days on the Discovery Coast, from Salvador to the remote shores of Corumbau." },
...
export const DEST_TRIP = {
  rio:            { days:7,  price:3400, regions:["Rio de Janeiro","Paraty","Ilha Grande"],
    intro:"Rio is loud, warm and impossibly scenic — but the version most travelers see barely scratches the surface. This journey pairs the postcard icons with the city's living neighborhoods, then trades the skyline for the dreamy colonial coast and a car-free island, so you feel the whole arc from urban energy to barefoot calm." },
...
export const BLOG_POSTS = [
  { slug:"the-brazil-most-tourists-miss", title:"The Brazil most tourists miss", date:"April 14, 2026", read:"7 min", category:"Stories", img:"/bahia.jpg", author:"Helena Cardoso", excerpt:"Three regions that almost never show up on a first-time itinerary — and why we send our most curious travelers there first." },
