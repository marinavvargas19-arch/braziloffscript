...
export const DESTINATIONS = [
  ...
  { slug:"pantanal",      name:"Pantanal & Bonito Off Script", region:"Mato Grosso do Sul",      category:"the-explorer",       img:PANTANAL_BONITO_IMG.day7FinalPantanal, blurb:"The world's largest wetland — jaguars, caiman-spotting, ecolodges and crystal-clear rivers." },
...
export const TOURS = [
  ...
  { slug:"pantanal-wildlife-8-days",  title:"Pantanal & Bonito Off Script",  days:12, price:4600, category:"the-explorer",       regions:["Campo Grande","Southern Pantanal","Bonito"],          img:PANTANAL_BONITO_IMG.day9CrystalRivers,     tags:["Wildlife","Birdwatching","Adventure"],blurb:"Southern Pantanal immersion, wildlife encounters, crystal-clear rivers, limestone caves, and Bonito's conservation stories." },
...
export const JALAPAO_ITIN = [
  { route:"Palmas Airport (PMW) → Palmas", city:"Arrival in Palmas", img:"/jalapao-topo.jpg", meals:"",
    blocks:[
  ...
  { route:"Palmas → Jalapão", city:"Into the Cerrado", img:"/jalapao-topo.jpg", meals:"Breakfast",
    blocks:[
  ...
  { route:"Jalapão · fervedouros and river beaches", city:"Crystal-Clear Springs", img:"/jalapao-natural-spring.jpeg", meals:"Breakfast",
    blocks:[
  ...
  { route:"Jalapão · waterfalls and rivers", city:"Waterfalls & Rivers", img:"/jalapao-waterfall.jpg", meals:"Breakfast",
    blocks:[
  ...
  { route:"Jalapão · local communities", city:"Local Traditions", img:"/jalapao-topo.jpg", meals:"Breakfast",
    blocks:[
  ...
  { route:"Jalapão · hidden corners", city:"Hidden Corners of the Jalapão", img:"/jalapao-natural-spring.jpeg", meals:"Breakfast",
    blocks:[
  ...
  { route:"Jalapão · canyons and viewpoints", city:"The Great Landscapes", img:"/jalapao-topo.jpg", meals:"Breakfast",
    blocks:[
  ...
  { route:"Jalapão → Palmas", city:"Return to Palmas", img:"/jalapao-topo.jpg", meals:"Breakfast",
    blocks:[
  ...
  { route:"Palmas → Palmas Airport (PMW)", city:"Departure", img:"/jalapao-topo.jpg", meals:"Breakfast",
    blocks:[
