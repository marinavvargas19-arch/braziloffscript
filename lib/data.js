...
export const DESTINATIONS = [
  ...
  { slug:"lencois",       name:"Lençóis Maranhenses - The Living Desert", region:"Maranhão",                category:"paradise-found",     img:IMG.lencois,              blurb:"White-sand dunes laced with freshwater lagoons — a landscape unlike anywhere else on earth." },
...
export const TOURS = [
  ...
  { slug:"pantanal-wildlife-8-days",  title:"Pantanal & Bonito Off Script",  days:12, price:4600, category:"the-explorer",       regions:["Campo Grande","Southern Pantanal","Bonito"],          img:"/bonito-river.jpg",     tags:["Wildlife","Birdwatching","Adventure"],blurb:"Southern Pantanal immersion, wildlife encounters, crystal-clear rivers, limestone caves, and Bonito's conservation stories." },
  { slug:"jalapao-expedition-7-days", title:"Jalapão Expedition",            days:9,  price:3900, category:"the-explorer",       regions:["Palmas","Jalapão"],                                  img:JALAPAO_MAIN_IMG, tags:["Adventure","Off-road","Nature"],    blurb:"Remote dirt roads, crystal-clear springs, golden dunes, rivers, and the living traditions of the cerrado." },
  ...
  { slug:"fernando-de-noronha-7-days", title:"Fernando de Noronha",          days:7,  price:4900, category:"paradise-found",     regions:["Fernando de Noronha"],                              img:"/noronha-beach.jpg",    tags:["Beach","Diving","Wildlife"],        blurb:"A slower island journey through protected beaches, marine life, ecological trails, and Noronha's unforgettable sunsets.",
    intro:"Fernando de Noronha is often celebrated for its turquoise waters and award-winning beaches. While those landscapes are spectacular, this journey is designed to reveal a deeper side of the archipelago. Beyond the iconic viewpoints, travelers discover one of the world's most important marine conservation areas through guided hikes, wildlife encounters, crystal-clear waters, and meaningful moments of connection with nature. Rather than rushing from beach to beach, this itinerary embraces the slower rhythm of island life, balancing adventure, relaxation, and unforgettable experiences both above and below the sea." },
  { slug:"lencois-and-northeast-9-days", title:"Lençóis Maranhenses - The Living Desert", days:9,  price:4400, category:"paradise-found",     regions:["São Luís","Lençóis Maranhenses","Jericoacoara"],    img:"/northeast-buggy.jpg",  tags:["Beach","Adventure","Nature"],       blurb:"Dunes, lagoons, fishing villages, and Jeri's barefoot dunes at sunset." },
