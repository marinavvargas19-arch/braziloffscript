...
const PANTANAL_BONITO_IMG = {
  campoGrande: "/pantanal-day-1-sunset.webp",
  pantanalRoad: "/pantanal-day-2-capybaras.webp",
  pantanalWaterways: "https://upload.wikimedia.org/wikipedia/commons/c/c2/Pantanal_Mato_Grosso_Brasil.jpg",
  pantanalWildlife: "/pantanal-day-5-jaguar.jpg",
  pantanalDay4Birdlife: "/pantanal-day-4-birdlife.webp",
  pantanalDay6Caiman: "/pantanal-day-6-caiman.jpg",
  pantanalBirdlife: "/toucan.jpg",
  bonitoRiver: "/bonito-river.jpg",
  bonitoCave: "https://upload.wikimedia.org/wikipedia/commons/3/34/Abismo_Anhumas%2C_Bonito%2C_MS.JPG",
  bonitoWaterfall: "/bonito-river.jpg",
};
...
export const DESTINATIONS = [
  ...
  { slug:"pantanal",      name:"Pantanal & Bonito Off Script", region:"Mato Grosso do Sul",      category:"the-explorer",       img:PANTANAL_BONITO_IMG.pantanalWaterways, blurb:"The world's largest wetland — jaguars, caiman-spotting, ecolodges and crystal-clear rivers." },
...
export const TOURS = [
  ...
  { slug:"pantanal-wildlife-8-days",  title:"Pantanal & Bonito Off Script",  days:12, price:4600, category:"the-explorer",       regions:["Campo Grande","Southern Pantanal","Bonito"],          img:PANTANAL_BONITO_IMG.bonitoRiver,     tags:["Wildlife","Birdwatching","Adventure"],blurb:"Southern Pantanal immersion, wildlife encounters, crystal-clear rivers, limestone caves, and Bonito's conservation stories." },
...
export const PANTANAL_ITIN = [
  { route:"Campo Grande Airport (CGR) → Campo Grande", city:"Gateway to the Wetlands", img:PANTANAL_BONITO_IMG.campoGrande, meals:"",
    blocks:[
  ...
  { route:"Campo Grande → Southern Pantanal", city:"Into the Wild Pantanal", img:PANTANAL_BONITO_IMG.pantanalRoad, meals:"Breakfast",
    blocks:[
  ...
  { route:"Southern Pantanal · waterways", city:"Life Along the Waterways", img:PANTANAL_BONITO_IMG.pantanalWaterways, meals:"Breakfast",
    blocks:[
  ...
  { route:"Southern Pantanal · wetlands", city:"Slow Exploration of the Wetlands", img:PANTANAL_BONITO_IMG.pantanalDay4Birdlife, meals:"Breakfast",
    blocks:[
  ...
  { route:"Southern Pantanal · wildlife habitats", city:"The Jaguar Landscape", img:PANTANAL_BONITO_IMG.pantanalWildlife, meals:"Breakfast",
    blocks:[
  ...
  { route:"Southern Pantanal · remote habitats", city:"Hidden Corners of the Wetlands", img:PANTANAL_BONITO_IMG.pantanalDay6Caiman, meals:"Breakfast",
    blocks:[
  ...
  { route:"Southern Pantanal · flexible exploration", city:"The Rhythm of the Wetlands", img:PANTANAL_BONITO_IMG.pantanalBirdlife, meals:"Breakfast",
    blocks:[
  ...
  { route:"Southern Pantanal → Bonito", city:"From Wetlands to Crystal Waters", img:PANTANAL_BONITO_IMG.bonitoRiver, meals:"Breakfast",
    blocks:[
  ...
  { route:"Bonito · crystal-clear rivers", city:"Crystal Waters of Bonito", img:PANTANAL_BONITO_IMG.bonitoRiver, meals:"Breakfast",
    blocks:[
  ...
  { route:"Bonito · Blue Lake Cave & sinkhole", city:"Beneath the Limestone World", img:PANTANAL_BONITO_IMG.bonitoCave, meals:"Breakfast",
    blocks:[
  ...
  { route:"Bonito · waterfalls and forest trails", city:"Waterfalls & Forest Trails", img:PANTANAL_BONITO_IMG.bonitoWaterfall, meals:"Breakfast",
    blocks:[
  ...
  { route:"Bonito → Campo Grande Airport (CGR)", city:"Departure", img:PANTANAL_BONITO_IMG.bonitoRiver, meals:"Breakfast",
    blocks:[
